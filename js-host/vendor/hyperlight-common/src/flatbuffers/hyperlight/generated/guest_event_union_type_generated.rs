...
impl GuestEventUnionType {
    ...
    pub const LogEvent: Self = Self(3);
    pub const EditSpan: Self = Self(4);
    pub const GuestStart: Self = Self(5);
    ...
    pub fn variant_name(self) -> Option<&'static str> {
        match self {
            Self::NONE => Some("NONE"),
            Self::OpenSpan => Some("OpenSpan"),
            Self::CloseSpan => Some("CloseSpan"),
            Self::LogEvent => Some("LogEvent"),
            Self::EditSpan => Some("EditSpan"),
            Self::GuestStart => Some("GuestStart"),
            _ => None,
        }
    }
}
